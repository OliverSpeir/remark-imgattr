...
Adds attributes to images by extending the default syntax like `![](path)(attribute1: value, attribute2: value)`. Attributes are applied to the image's `hProperties`, enabling framework component props in Astro and other unified pipelines.
